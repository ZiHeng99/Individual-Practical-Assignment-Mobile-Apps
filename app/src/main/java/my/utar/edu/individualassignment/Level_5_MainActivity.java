...
public class Level_5_MainActivity extends Activity {
    ...
    private void highlightRandomBox() {
        ...
        box10.setBackgroundColor(Color.BLACK);
        box11.setBackgroundColor(Color.BLACK);
        box12.setBackgroundColor(Color.BLACK);
        box13.setBackgroundColor(Color.BLACK);
        box14.setBackgroundColor(Color.BLACK);
        box15.setBackgroundColor(Color.BLACK);
        box16.setBackgroundColor(Color.BLACK);
        box17.setBackgroundColor(Color.BLACK);
        box18.setBackgroundColor(Color.BLACK);
        box19.setBackgroundColor(Color.BLACK);
        box20.setBackgroundColor(Color.BLACK);
        box21.setBackgroundColor(Color.BLACK);
        box22.setBackgroundColor(Color.BLACK);
        box23.setBackgroundColor(Color.BLACK);
        box24.setBackgroundColor(Color.BLACK);
        box25.setBackgroundColor(Color.BLACK);
        box26.setBackgroundColor(Color.BLACK);
        box27.setBackgroundColor(Color.BLACK);
        box28.setBackgroundColor(Color.BLACK);
        box29.setBackgroundColor(Color.BLACK);
        box30.setBackgroundColor(Color.BLACK);
        box31.setBackgroundColor(Color.BLACK);
        box32.setBackgroundColor(Color.BLACK);
        box33.setBackgroundColor(Color.BLACK);
        box34.setBackgroundColor(Color.BLACK);
        box35.setBackgroundColor(Color.BLACK);
        box36.setBackgroundColor(Color.BLACK);
